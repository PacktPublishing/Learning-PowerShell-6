...
<#
    .Synopsis
       Test only
    .DESCRIPTION
       This does nothing. It is only for testing to see that as a function, it is available.
    .EXAMPLE
       Type New-testdh and press the Tab key to see if PowerShell can autocomplete it.
                #>
